...
enum SENDDATA_STATUS {SEND_NOTHING=0, SEND_RESPHEAD, SEND_HEAD1, SEND_HEAD2, SEND_HEAD3, SEND_BODY, SEND_BLOCKED, SEND_EOF, /*SEND_BLOCKED*/}; //add block by jayg
...
#define ci_get_flag(req)     ((req)->flag)
#define ci_set_flag(req,value)     ((req)->flag=value)
/*API functions ......*/
